...
- Before an intentional Open, Cloud, or CLI product release, always
...
- Read and apply `.agents/skills/tasks/oss/SKILL.md` after substantive code,
  configuration, dependency, documentation, or repository-structure changes.
  It keeps the public tree free of private context, temporary residue, dead
  scaffolding, unnecessary comments, and accidental local artifacts. `/oss`
  or `$oss` also requests a focused open-source hygiene audit.
