...
Creed products follow [Semantic Versioning](https://semver.org/). Commits record work; versions and Git tags mark deliberate product releases. A commit landing on `main` does not automatically advance Open, Cloud, or CLI. The status site, docs site, and marketing pages are not versioned products.
