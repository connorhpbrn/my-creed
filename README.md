...
The guided installer connects Supabase, creates the private local environment, previews and applies Creed's database, and verifies the installation. Open [http://localhost:3001](http://localhost:3001), enter the 9-digit owner code from setup once, and complete Personal onboarding.
