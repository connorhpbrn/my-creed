  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h3>Personal writes are missing</h3>
        <p>A current schema version is not enough if the database API no longer exposes personal writes. Re-apply the Open migrations from this repository and run <InlineCode>npm run doctor</InlineCode>. The app stays on setup until that write path is visible.</p>
