...
import { OPEN_ENTER_PATH, withOpenNextQuery } from "@creed/open/lib/open-next-path";
...
export default async function AuthorizePage({
  ...
  try {
    ...
    // redirect() throws a NEXT_REDIRECT marker. Catching it here used to
    // swallow the unsigned-in hop to /enter and render this failure copy.
...
async function renderAuthorize(params: SearchParams) {
  ...
  // Reconstruct this page's own URL so a signed-out owner returns here after
  // entering the owner code.
  ...
  return (
    <Shell>
      ...
      <p className="mt-3 text-[14px] leading-7 text-[var(--creed-text-secondary)]">
        ...
        section directly when you allow direct edits.
      </p>
