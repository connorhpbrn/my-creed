  ...
  public: {
    Tables: {
      ...
      creed_credit_homes: {
        ...
        Relationships: [
          {
            foreignKeyName: "creed_credit_homes_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_credit_reservations: {
        Row: {
          ...
          id: string
          model_id: string
          reserved_granted_micro_usd: number
          reserved_purchased_micro_usd: number
          settled_at: string | null
          spent_by_user_id: string | null
          status: string
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "creed_credit_reservations_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_credit_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "creed_credit_transactions_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_credits: {
        ...
        Relationships: [
          {
            foreignKeyName: "creed_credits_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: true
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_invites: {
        ...
        Relationships: [
          {
            foreignKeyName: "creed_invites_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_member_agent_permissions: {
        Row: {
          creed_id: string
          permission: string
          section_id: string
        ...
        Relationships: [
          {
            foreignKeyName: "creed_member_agent_permissions_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      creed_member_section_permissions: {
        ...
        Relationships: [
          {
            foreignKeyName: "creed_member_section_permissions_creed_id_fkey"
            columns: ["creed_id"]
            isOneToOne: false
            referencedRelation: "creeds"
            referencedColumns: ["id"]
      ...
      sponsor_donations: {
        Row: {
          ...
          created_at: string
          dispute_event_created: number | null
          dispute_status: string | null
          failed_at: string | null
          id: string
          refund_event_created: number | null
          sponsor_id: string
          status: string
        ...
        Relationships: [
          {
            foreignKeyName: "sponsor_donations_sponsor_id_fkey"
            columns: ["sponsor_id"]
            isOneToOne: false
    ...
    Functions: {
      ...
      credit_spend_total: { Args: { p_creed_id: string }; Returns: number }
      credit_topup: {
        Args: {
      ...
      prune_abandoned_sponsor_payments: { Args: never; Returns: number }
      refund_credit_topup: {
      ...
      set_credit_home: {
        Args: { p_creed_id: string; p_user_id: string }
        Returns: string
      }
      settle_credit_reservation: {
        Args: { p_actual_micro: number; p_reservation_id: string }
        Returns: number
      }
      transfer_credit_home: {
        Args: { p_from_creed_id: string; p_to_creed_id: string }
        Returns: undefined
      }
      transfer_creed_ownership: {
        Args: { p_creed_id: string; p_from: string; p_to: string }
        Returns: undefined
      }
      update_creed_section_positions: {
        Args: {
          p_creed_id: string
