...
// Keep recharts' hover cursor and position animation so the tip glides
// between bars. The wrapper stays visible so visibility:hidden cannot clip
// the content fade-out in ChartTooltipContent.
