...
function renderSharedContext({
  ...
  return [
    ...
    '- Controls (each implies navigating to model-usage): kind "usage-range" (value 7d|30d|90d|all; "this week"=7d, "this month"=30d, longer=90d, "all time"/"ever"=all); kind "usage-mode" (value credits|byok; BYOK spend needs byok).',
