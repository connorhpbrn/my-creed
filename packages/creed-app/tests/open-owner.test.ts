...
test("owner codes are exactly nine digits", () => {
  assert.equal(isOpenOwnerCode("123456789"), true);
  assert.equal(isOpenOwnerCode("000000001"), true);
  assert.equal(isOpenOwnerCode("12345678"), false);
  assert.equal(isOpenOwnerCode("1234567890"), false);
  assert.equal(isOpenOwnerCode("12345678a"), false);
});
