...
export const CONNECTION_SECONDARY_BUTTON_CLASS =
  "min-w-[116px] justify-center rounded-md border border-[var(--creed-border-strong)] bg-[var(--creed-surface)] text-[var(--creed-text-primary)] hover:bg-[var(--creed-surface-raised)]";
...
export function ConnectionCard({
  ...
  const buttonClass = cn(
    "min-w-[116px] justify-center rounded-md",
