                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          ...
                          className="border-[var(--creed-border)] bg-[var(--creed-surface)] aria-expanded:bg-[var(--creed-surface-raised)]! aria-expanded:hover:bg-[var(--creed-surface-raised)]! dark:aria-expanded:bg-input/50! dark:aria-expanded:hover:bg-input/50!"
                        >
