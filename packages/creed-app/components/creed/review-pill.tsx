...
export const ReviewPill = memo(function ReviewPill({
  ...
  return (
    <div
      ref={pillRef}
      className="inline-flex max-w-full items-center gap-1 rounded-xl border border-[var(--creed-border)] bg-[var(--creed-surface)] px-1.5 py-1"
    >
      <DropdownMenu
        open={open}
        onOpenChange={(next) => {
                ...
                <DropdownMenuSubTrigger className={cn(DROPDOWN_ITEM_CLASS, "group/sub hover:bg-[var(--creed-surface-raised)] [&>svg:last-of-type]:hidden")}>
                  <div className="flex min-w-0 flex-1 items-center gap-1.5">
                    ...
                    <AnimatedChevronDown
                      ...
                      className="ml-auto rotate-90 shrink-0 transition-all duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover/sub:-rotate-90 group-data-[state=open]/sub:-rotate-90 [&_svg]:h-[14px]! [&_svg]:w-[14px]! [&_svg]:stroke-[var(--creed-text-tertiary)]! group-hover/sub:[&_svg]:stroke-[var(--creed-text-primary)]! group-data-[state=open]/sub:[&_svg]:stroke-[var(--creed-text-primary)]!"
                    />
                  </div>
                </DropdownMenuSubTrigger>
                <DropdownMenuPortal>
  ...
  return (
    <div className="rounded-[var(--radius-md)] hover:bg-[var(--creed-surface-raised)]">
      ...
      >
        ...
        <AnimatedChevronDown
          size={14}
          className="-rotate-90 ml-auto shrink-0 origin-center text-[var(--creed-text-tertiary)] transition-[color,transform,rotate] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:text-[var(--creed-text-primary)] in-aria-expanded:rotate-0 in-aria-expanded:text-[var(--creed-text-primary)]"
        />
      </button>
