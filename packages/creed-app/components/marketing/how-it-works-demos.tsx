            ...
            >
              ...
              <div className="mt-3 flex justify-end">
                <Button
                  ...
                  className="bg-[var(--creed-text-primary)] text-[var(--creed-button-primary-fg)] hover:bg-[var(--creed-button-primary-hover)]"
                  tabIndex={-1}
                >
                  Continue
            ...
            >
              ...
              <div className="mt-4">
                <AnimatedIconButton
                  ...
                  icon={CopyIcon}
                  showIcon={phase === 0}
                  className="creed-copy-cycle min-w-[116px] justify-center rounded-md text-white"
                  tabIndex={-1}
                  onClick={() => setPhase(1)}
                >
                  {phase === 1 ? (
