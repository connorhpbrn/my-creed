      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-8 md:px-10 md:pb-24 md:pt-10">
        <div className="flex items-center justify-between gap-6 border-b border-[var(--creed-border)] pb-8">
          ...
          <button
            ...
            className="inline-flex h-9 shrink-0 items-center justify-center gap-2.5 rounded-md bg-[#2563eb] px-3 text-[14px] font-medium text-white shadow-[0_1px_2px_rgba(0,0,0,0.12),0_3px_6px_rgba(0,0,0,0.06)] transition-colors hover:bg-[#3b76ef] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
          >
            Contribute
            <HeartHandshakeIcon
