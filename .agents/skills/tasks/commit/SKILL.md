...
4. Classify the commit before staging:
   - **ordinary commit:** records completed work but does not release Open, Cloud, or CLI; do not bump a product version or create a release tag;
...
- Do not bump Open, Cloud, or CLI merely because a commit lands on `main`.
